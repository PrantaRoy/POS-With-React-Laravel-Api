...
const AddCategory = () =>{
     ...
     const handleCategory = () => {
          console.log(input)
          setIsLoading(true)
          axios.post(`${Constants.Base_Url}/category/store`,input).then(res=>{
                              ...
                              <div className="card-footer">
                                   <div className="row">
                                        <div className="d-grid">
                                             <button className="btn btn-primary" onClick={handleCategory} dangerouslySetInnerHTML={{__html : isLoading  ? '<span className="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading' : 'Submit'}} />
                                        </div>
                                   </div>
                              </div>
                         </div>
